...
let
  ...
  customcss = ''
    ...
    .app-menu-entry--label {
      color: white !important; /* TODO avoid hardcoding this */
    }
    .app-menu-entry__active::before {
      background-color: white !important; /* TODO avoid hardcoding this */
    }
  '';
in
{
    ...
    services.nextcloud = {
      extraApps = {
        inherit (config.services.nextcloud.package.packages.apps)
          theming_customcss # (no support for nextcloud33)
          unroundedcorners
          ;
      };
      extraOCCCommands = ''
